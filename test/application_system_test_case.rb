...
class ApplicationSystemTestCase < ActionDispatch::SystemTestCase
  ...
  # The Capybara twin of ActiveSupport::TestCase#assert_progress: one star per card, filled for
  # the cleared ones.
  def assert_progress(cleared:, of:)
    assert_selector "#progress", visible: :all
    assert_selector "#progress svg.pip", count: of
    assert_selector "#progress svg.pip-lit", count: cleared
  end
